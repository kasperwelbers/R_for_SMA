...
Long story short, these tutorial documents are themselves generated in R (using RMarkdown).
...
You can also use the Social Media Analytics [JupyterHub](https://hub.compute.vu.nl/) together with this [tutorial](https://societal-analytics.nl/blogs/20250201_computing-power/).
...
The data you will use during Q5 is stored in: `/srv/scistore/data/SMA/data`

The directories where you can store your codes and own generated data are based on your teams’ group and number.
For example, if your group is 2 and your team 4, then you can access your file as: `/srv/scistor/data/SMA/group204/` Or, if your group is 4 and your team 10, then you can access your file as: `/srv/scistor/data/SMA/group410/`

To acces either the Q5 data or your folder, you can follow the steps in the image beneath:
