...
scrape_reddit <- function(query, period) {
  ## get threads
  threads = find_thread_urls(query, period=period)
...
```{r, eval=F}
content = scrape_reddit('rstats', 'week')
```
