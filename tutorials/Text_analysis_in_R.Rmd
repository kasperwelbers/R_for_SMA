...
```{r}
offensive_tweets = read_csv('~/projects/R_for_SMA/data/machine_learning_tweets/offensive_tweets.csv')
...
> **Question 3.b**.
> Describe in your own words what each step in your code does. Imagine you're explaning it to someone that doesn't know R.
...
> the two wordclouds from the hate_tweets training data to explain this to him. (+/- 200 words)
